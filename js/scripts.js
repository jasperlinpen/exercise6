  ...
  // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ Begin
   function step1(stockNo,item_show) {
   ...
   async function executeStepsSequentially(stockNo,item_show) {
       try {
          let result1 = await step1(stockNo,item_show);
        // console.log(result1); // Step 1 結果
  ...
  // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ End
   function timestampToTime(timestamp) {
    ...
    // **************************
	  function showElement(stockNo,item_show) {
		if ( item_show == 1 ) {
		   if  (mask_item1.style.display == "none" ) 
			   executeStepsSequentially(stockNo,item_show); 
           else
      		   mask_item1.style.display = "none" ;
		} 
		if ( item_show == 2 ) {
		   if  (mask_item2.style.display == "none" ) 
			    executeStepsSequentially(stockNo,item_show); 
           else
